...
if(array_key_exists('action', $_POST)){
    ...
    if($action == 'getQuizItems'){
        ...
        //Store a signed in flag indicating that the user has signed in successfully
        //make a function to do this
        signIn($_POST);
    } else if($action == 'signOut'){
        //delete the signed in flag
        signOut();
...
function signIn($data){
    ...
    echo json_encode([
        'success' => true,
        'message' => 'Successfully added sign in cookie'
    ]);
}
...
function signOut(){
    ...
    echo json_encode([
        'success' => true,
        'message' => 'Successfully removed sign in cookie'
    ]);
}
